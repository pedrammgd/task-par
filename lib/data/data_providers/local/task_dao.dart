...
class TaskDao extends DatabaseAccessor<AppDatabase> with _$TaskDaoMixin {
  ...
  Stream<List<TaskWithCategory>> watchAllTasks() {
    ...
    return toTaskWithCategory(query as JoinedSelectStatement<Table, DataClass>);
  }
  ...
  Stream<List<CategoryTotalTask>> watchAllTaskCategories() {
    ...
    return toCategoryTotalTask(
        query as JoinedSelectStatement<Table, DataClass>, amountOfTasks);
  }
